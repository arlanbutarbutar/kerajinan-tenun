...
<html lang="en">
  ...
  <head>
    ...
    <title>Kerajinan Tenun dan Gerabah</title>
...
menu();
 ...
 if($page=="beranda"){
...
else if($page=="hapusLokasi"){
    hapusLokasi();
  }
  else if($page=="detailLokasi"){
    detailLokasi();
  }
  ...
  else if($page=="daftarTambah"){
    daftarTambah();
  }
  else if($page=="detailDaftar"){
    detailDaftar();
  }
  else if($page=="hapusDaftar"){
    hapusDaftar();
  }
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2022 <a href="#">ReiVan</a> Company. All rights reserved. 
